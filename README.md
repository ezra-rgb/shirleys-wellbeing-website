...
Photography for all eleven slots, the logo, social URLs, privacy/terms/accessibility text, CIC registration number and registered office, and the live domain. See `src/config/site.ts` flags.
